//           ##################### 3. Loops and Strings   #####################                  
console.log("##################### 3. Loops and Strings   #####################");
...
console.log(`Replace first occurence of character W with v: ${newData.replace("W", "V")}`); // Only first time replace. use replaceAll which replace all data
console.log("Replace all occurences of A with E", newData.replaceAll("a", "e"));
